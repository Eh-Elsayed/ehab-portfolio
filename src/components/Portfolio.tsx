...
const productReviews: { name: string; url: string; cat: string; hasPhotos?: boolean }[] = [
  ...
  { name: "ASUS TUF Gaming B860M-Plus WiFi", url: "https://arabhardware.net/reviews/asus-tuf-gaming-b860m-plus-wifi-review", cat: "Motherboard" },
  { name: "ASUS TUF Gaming B850-Plus WiFi", url: "https://arabhardware.net/reviews/asus-tuf-gaming-b850-plus-wifi-review", cat: "Motherboard" },
  { name: "ASUS Prime 850W Gold", url: "https://arabhardware.net/reviews/asus-prime-850w-gold-review", cat: "PSU" },
  { name: "Deepcool Mystique 360", url: "https://arabhardware.net/reviews/deepcool-mystique-360-review", cat: "Cooling" },
  { name: "Iota C70 BK ARGB", url: "https://arabhardware.net/reviews/iota-c70-bk-argb-review", cat: "Case" },
  { name: "Ocypus Lota L36", url: "https://arabhardware.net/reviews/ocypus-lota-l36-review", cat: "Case" },
  ...
  { name: "TerraMaster F4-424 Max", url: "https://arabhardware.net/reviews/terramaster-f4-424-max-review", cat: "NAS" },
  { name: "Why Lenovo RTX for School", url: "https://arabhardware.net/articles/why-lenovo-rtx-powered-best-for-school", cat: "Article" },
  { name: "Gaming vs Study Laptops 2024", url: "https://arabhardware.net/articles/gaming-studying-laptop-features-2024", cat: "Article" },
